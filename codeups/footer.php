      ...
      <div class="footer__header">
        ...
        <div class="footer__icons">
          <a href="#" class="footer__icon hover-opacity">
            <img src="<?php echo esc_url( get_theme_file_uri('/assets/images/footer-facebook.png') ); ?>" alt="CodeUpsのFacebook">
          </a>
          <a href="#" class="footer__icon hover-opacity">
            <img src="<?php echo esc_url( get_theme_file_uri('/assets/images/footer-instagram.png') ); ?>" alt="CodeUpsのInstagram">
          </a>
        </div>
      </div>
